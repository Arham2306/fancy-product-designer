...
if(!class_exists('FPD_Scripts_Styles')) {
        ...
        class FPD_Scripts_Styles {
                ...
                public function register() {
                        ...
                        wp_register_style( 'fpd-datetime-picker', plugins_url('/assets/css/date-picker.css', FPD_PLUGIN_ROOT_PHP), false, Fancy_Product_Designer::VERSION );
                        ...
                        wp_register_script( 'fpd-datetime-picker', plugins_url('/assets/js/datetime-picker.js', FPD_PLUGIN_ROOT_PHP), array('jquery', 'fpd-js'), $debug_mode ? $timestamp : Fancy_Product_Designer::VERSION );
                ...
                public function enqueue_styles() {
                        ...
                        wp_enqueue_style( 'fpd-datetime-picker' );
                        ...
                        wp_enqueue_script( 'fpd-datetime-picker' );
