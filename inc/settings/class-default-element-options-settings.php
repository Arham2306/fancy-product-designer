                ...
                'coloring' => array(
                    ...
                    array(
                        ...
                        'unbordered'      => true
                                ...
                                'custom-datetime' => array(
                    
                    array(
                        'description' => __( 'These properties will be applied to all datetime picker elements that are added by your customers.', 'radykal' ),
                        'type' => 'description',
                        'id' => 'custom-datetime-desc'
                    ),
                    
                    array(
                        'title' => __('Positioning', 'radykal'),
                        'type' => 'section-title',
                        'id' => 'datetime-positioning-section'
                    ),
                    
                    array(
                        'title' => __( 'Auto-Center', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_autoCenter',
                        'default' => 'yes',
                        'type' => 'checkbox',
                        'relations' => array(
                            'fpd_custom_datetime_parameter_x' => false,
                            'fpd_custom_datetime_parameter_y' => false,
                        ),
                    ),

                    array(
                        'title' => __( 'Left', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_x',
                        'css' => 'width:70px;',
                        'default' => '0',
                        'type' => 'number',
                        'custom_attributes' => array(
                    ...
                    array(
                        'title' => __( 'Top', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_y',
                        'css' => 'width:70px;',
                        'default' => '0',
                        'type' => 'number',
                        'custom_attributes' => array(
                    ...
                    array(
                        'title' => __( 'Layer Depth', 'radykal' ),
                        'description' => __( '-1 means that the element will be added at the top. Any value higher than that will add the element to that layer depth.', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_z',
                        'css' => 'width:70px;',
                        'default' => '-1',
                        'type' => 'number',
                        'custom_attributes' => array(
                    ...
                    array(
                        'title' => __('Customizable Properties', 'radykal'),
                        'type' => 'section-title',
                        'id' => 'datetime-customizable-props-section'
                    ),

                    array(
                        'title' => __( 'Draggable', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_draggable',
                        'default' => 'yes',
                        'type' => 'checkbox',
                        'column_width' => 'eight'
                    ),
                    ...
                    array(
                        'title' => __( 'Rotatable', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_rotatable',
                        'default' => 'no',
                        'type' => 'checkbox',
                        'column_width' => 'eight'
                    ),
                    ...
                    array(
                        'title' => __( 'Resizable', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_resizable',
                        'default' => 'yes',
                        'type' => 'checkbox',
                        'column_width' => 'eight'
                    ),
                    ...
                    array(
                        ...
                        'id' => 'fpd_custom_datetime_parameter_removable',
                        'default' => 'yes',
                        'type' => 'checkbox',
                        'column_width' => 'eight'
                    ),
                    ...
                    array(
                        'title' => __('Pricing', 'radykal'),
                        'type' => 'section-title',
                        'id' => 'datetime-pricing-section'
                    ),
                    
                    array(
                        'title' => __( 'Price', 'radykal' ),
                        'description' => __( 'Enter the additional price for a datetime picker element. Always use a dot as decimal separator!', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_price',
                        'css' => 'width:70px;',
                        'default' => '0',
                        'type' => 'number',
                        'custom_attributes' => array(
                    ...
                    array(
                        'title' => __('DateTime Options', 'radykal'),
                        'type' => 'section-title',
                        'id' => 'datetime-options-section'
                    ),

                    array(
                        'title' => __( 'Default Format', 'radykal' ),
                        'description' => __( 'Default date-time format for new datetime picker elements.', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_format',
                        'css' => 'width:150px;',
                    ...
                    array(
                        ...
                        'description' => __( 'Allow users to select time in addition to date.', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_enableTime',
                        'default' => 'yes',
                        'type' => 'checkbox',
                        'column_width' => 'eight'
                    ),
                    ...
                    array(
                        ...
                        'description' => __( 'Minimum selectable date (YYYY-MM-DD format). Leave empty for no limit.', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_minDate',
                        'css' => 'width:150px;',
                        'default' => '',
                        'type' => 'text',
                        'column_width' => 'eight'
                    ...
                    array(
                        ...
                        'description' => __( 'Maximum selectable date (YYYY-MM-DD format). Leave empty for no limit.', 'radykal' ),
                        'id' => 'fpd_custom_datetime_parameter_maxDate',
                        'css' => 'width:150px;',
                        'default' => '',
                        'type' => 'text',
                        'column_width' => 'eight'
