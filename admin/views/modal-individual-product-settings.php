<?php
        ...
        require_once(FPD_PLUGIN_DIR.'/inc/settings/ips/class-datetime-settings.php');
        ...
        $tabs = array(
                ...
                'custom-datetime-options' => __('DateTime Picker Properties', 'radykal'),
        ...
        $tabs_options = array(
                ...
                'custom-datetime-options' => FPD_IPS_DateTime::get_options(),
